...
{
	public static void runParallelMerge(List<Integer> sortArray, int numCores)
	{
		ExecutorService executor = Executors.newFixedThreadPool(numCores);
		CountDownLatch latch = new CountDownLatch(numCores);
		MultithreadedMergeSort sort = new MultithreadedMergeSort(latch);
...
class MultithreadedMergeSort implements Runnable
{
	...
	public MultithreadedMergeSort(CountDownLatch latch)
	{
		mLatch = latch;
	}
	...
	public MultithreadedMergeSort setUp(List<Integer> sortArray, int numCores)
	{
